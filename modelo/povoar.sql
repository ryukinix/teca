...
-- -----------------------------------------------------
-- Placeholder table for view `view_professor_cod_curso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `view_professor_cod_curso` (`cod_curso` INT, `nome_curso` INT, `nome` INT);
SHOW WARNINGS;
...
-- -----------------------------------------------------
-- View `view_professor_cod_curso`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `view_professor_cod_curso`;
SHOW WARNINGS;
DROP VIEW IF EXISTS `view_professor_cod_curso` ;
SHOW WARNINGS;
USE `equipe385145`;
CREATE  OR REPLACE VIEW view_professor_cod_curso as
 SELECT c.cod_curso, c.nome_curso, nome
 FROM (professor p join usuario u
 ON p.mat_siape = u.matricula
 ) , curso c
