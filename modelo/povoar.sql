...
CREATE TABLE IF NOT EXISTS `aluno` (
  `matricula` INT NOT NULL,
  `data_de_conlusao_prevista` VARCHAR(6) NOT NULL,
  `data_de_ingresso` VARCHAR(6) NOT NULL,
  `cod_curso` INT NOT NULL,
  PRIMARY KEY (`matricula`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `professor` (
  ...
  `data_de_contratacao` VARCHAR(6) NOT NULL,
...
START TRANSACTION;
USE `equipe385145`;
INSERT INTO `emprestimo` (`matricula`, `isbn`, `data_de_emprestimo`) VALUES (400500, '\'978987654300\'', '2018-04-20');
