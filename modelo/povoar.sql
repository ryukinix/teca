...
CREATE TABLE IF NOT EXISTS `autor` (
  ...
  `nacionalidade` VARCHAR(45) GENERATED ALWAYS AS () VIRTUAL,
  PRIMARY KEY (`cpf`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `aluno` (
  `matricula` INT NOT NULL,
  `data_de_conlusao_prevista` DATETIME NOT NULL,
  `data_de_ingresso` DATETIME NOT NULL,
  `cod_curso` INT NOT NULL,
  PRIMARY KEY (`matricula`),
  INDEX `fk_aluno_usuario_idx` (`matricula` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `professor` (
  ...
  `cod_curso` INT NOT NULL,
  INDEX `fk_professor_usuario1_idx` (`mat_siape` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `funcionario` (
  `matricula` INT NOT NULL,
  PRIMARY KEY (`matricula`),
  INDEX `fk_funcionario_usuario1_idx` (`matricula` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `autor_livro` (
  ...
  INDEX `fk_autor_has_livro_autor1_idx` (`autor_cpf` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `emprestimo` (
  `matricula` INT NOT NULL,
  `isbn` CHAR(13) NOT NULL,
  `data_de_emprestimo` INT NOT NULL,
  PRIMARY KEY (`matricula`, `isbn`),
  INDEX `fk_usuario_has_livro_livro1_idx` (`isbn` ASC) VISIBLE,
  INDEX `fk_usuario_has_livro_usuario1_idx` (`matricula` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `reserva` (
  ...
  PRIMARY KEY (`matricula`, `isbn`),
  INDEX `fk_usuario_has_livro_livro2_idx` (`isbn` ASC) VISIBLE,
  INDEX `fk_usuario_has_livro_usuario2_idx` (`matricula` ASC) VISIBLE)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `equipe385145`;
INSERT INTO `aluno` (`matricula`, `data_de_conlusao_prevista`, `data_de_ingresso`, `cod_curso`) VALUES (389118, '2021.2', '2016.2', 001);
INSERT INTO `aluno` (`matricula`, `data_de_conlusao_prevista`, `data_de_ingresso`, `cod_curso`) VALUES (385145, '2021.2', '2016.2', 001);
INSERT INTO `aluno` (`matricula`, `data_de_conlusao_prevista`, `data_de_ingresso`, `cod_curso`) VALUES (398608, '2022.1', '2017.1', 002);
...
START TRANSACTION;
USE `equipe385145`;
INSERT INTO `professor` (`mat_siape`, `data_de_contratacao`, `regime_trabalho`, `cod_curso`) VALUES (400500, '2015.2', 'DE', 001);
INSERT INTO `professor` (`mat_siape`, `data_de_contratacao`, `regime_trabalho`, `cod_curso`) VALUES (400501, '2007.1', '40H', 002);
INSERT INTO `professor` (`mat_siape`, `data_de_contratacao`, `regime_trabalho`, `cod_curso`) VALUES (400101, '2006.2', '20H', 003);
...
INSERT INTO `livro` (`isbn`, `titulo`, `ano`, `editora`, `qt_copias`, `cod_categoria`) VALUES ('978123456789', 'Banco de dados', 2008, 'UFC-Quixadá', 100, 03);
...
START TRANSACTION;
USE `equipe385145`;
INSERT INTO `emprestimo` (`matricula`, `isbn`, `data_de_emprestimo`) VALUES (400500, '97812345678', 20/04/2018);
INSERT INTO `emprestimo` (`matricula`, `isbn`, `data_de_emprestimo`) VALUES (389118, '978987654321', 22/10/2018);
INSERT INTO `emprestimo` (`matricula`, `isbn`, `data_de_emprestimo`) VALUES (394192 , '978789456123', 24/11/2018);
...
START TRANSACTION;
USE `equipe385145`;
INSERT INTO `reserva` (`matricula`, `isbn`, `data_de_reserva`) VALUES (389118, '978987654321', '22/10/2018');
INSERT INTO `reserva` (`matricula`, `isbn`, `data_de_reserva`) VALUES (394192 , '978789456123', '23/10/2018');
INSERT INTO `reserva` (`matricula`, `isbn`, `data_de_reserva`) VALUES (385145, '98785296371', '24/102018');
